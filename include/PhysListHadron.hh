...
// ********************************************************************
//
// $Id: PhysListHadron.hh 68007 2013-03-13 11:28:03Z gcosmo $
//
/// \file radioactivedecay/rdecay02/include/PhysListHadron.hh
/// \brief Definition of the PhysListHadron class
//
...
{
  public:
    PhysListHadron(const G4String& name = "hadron");
    virtual ~PhysListHadron();
