...
#ifndef DetectionSystemGermaniumCylinder_h
#define DetectionSystemGermaniumCylinder_h 1
...
{
  public:
    DetectionSystemGermaniumCylinder();
    ~DetectionSystemGermaniumCylinder();
  ...
  private:
    ...
    G4LogicalVolume* packing_back_lid_log;

    G4LogicalVolume* copper_cylinder_log;
...
//    SensitiveDetector* crystal_block_SD;
  ...
  private: 
    ...
    G4String copper_material;

    G4double detail_view_end_angle;
    G4double crystal_length_z;
    G4double crystal_inner_radius;
    G4double crystal_outer_radius;
    G4double crystal_core_length_z;
    G4double crystal_core_cut_length_z;
    G4double crystal_core_inner_radius;
    G4double crystal_core_outer_radius;

    G4double copper_length_z;
    G4double copper_inner_radius;
    G4double copper_outer_radius;
    ...
    G4double packing_back_lid_thickness;
...
//    G4int Build(G4SDManager* mySDman);
  ...
  private: 
    ...
    G4Tubs* BuildPackingBackLid();
    G4Tubs* BuildCore();
    G4Tubs* BuildCopperClamp();
    
  private:
    G4int BuildCoreVolume();
    G4int BuildCopperClampVolume();
