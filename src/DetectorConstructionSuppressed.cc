...
{
  this->griffinFwdBackPosition = 11.0*cm;
...
//  myMaterials.push_back(Vacuum); // "Galatic" Vacuum
  ...
  G4Material* Vacuum_density_yoctogram_per_cm3 = new G4Material(name="Vacuum_density_yoctogram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_yoctogram_per_cm3);

  density     = 1.e-9*g/cm3;
  G4Material* Vacuum_density_nanogram_per_cm3 = new G4Material(name="Vacuum_density_nanogram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_nanogram_per_cm3);

  density     = 10.e-9*g/cm3;
  G4Material* Vacuum_density_10nanogram_per_cm3 = new G4Material(name="Vacuum_density_10nanogram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_10nanogram_per_cm3);

  density     = 100.e-9*g/cm3;
  G4Material* Vacuum_density_100nanogram_per_cm3 = new G4Material(name="Vacuum_density_100nanogram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_100nanogram_per_cm3);

  density     = 1.e-6*g/cm3;
  G4Material* Vacuum_density_microgram_per_cm3 = new G4Material(name="Vacuum_density_microgram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_microgram_per_cm3);

  density     = 1.e-3*g/cm3;
  G4Material* Vacuum_density_milligram_per_cm3 = new G4Material(name="Vacuum_density_milligram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_milligram_per_cm3);

  density     = 1.e-2*g/cm3;
  G4Material* Vacuum_density_centigram_per_cm3 = new G4Material(name="Vacuum_density_centigram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_centigram_per_cm3);

  density     = 1.e-1*g/cm3;
  G4Material* Vacuum_density_decigram_per_cm3 = new G4Material(name="Vacuum_density_decigram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_decigram_per_cm3);

  density     = 1.0*g/cm3;
  G4Material* Vacuum_density_gram_per_cm3 = new G4Material(name="Vacuum_density_gram_per_cm3", z=1., a=1.01*g/mole, density);
  myMaterials.push_back(Vacuum_density_gram_per_cm3);

  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  // From http://geant4.cern.ch/support/source/geant4/examples/advanced/purging_magnet/src/PurgMagDetectorConstruction.cc
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  G4Material* LaBr = new G4Material(name="Lanthanum_Bromide", density=5.08*g/cm3, nelements=2);
  LaBr->AddElement(elLa, natoms=1);
  LaBr->AddElement(elBr, natoms=3);
  myMaterials.push_back(LaBr);

  G4Material* LaBrCe = new G4Material(name="Cerium_Doped_Lanthanum_Bromide", density=5.08*g/cm3, nelements=2);
  ...
  G4Material* LN2 = new G4Material("Liquid_N2", density=804*kg/m3, ncomponents=1);
  ...
  G4Material* PureIron = new G4Material("PureIron", density = 7.874*g/cm3, ncomponents=1);
  PureIron->AddElement(elFe, 100.*perCent);
  myMaterials.push_back(PureIron);
  ...
  G4Material* G4_SODIUM_IODIDE_PLUS_Tl = new G4Material( "G4_SODIUM_IODIDE_PLUS_Tl", density=3.667*g/cm3, ncomponents = 2);
  G4_SODIUM_IODIDE_PLUS_Tl->AddMaterial( SODIUM_IODIDE, 99.9*perCent );
  G4_SODIUM_IODIDE_PLUS_Tl->AddMaterial( Tl, 0.1*perCent );
  myMaterials.push_back(G4_SODIUM_IODIDE_PLUS_Tl);
